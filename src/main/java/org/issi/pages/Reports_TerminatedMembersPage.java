...
public class Reports_TerminatedMembersPage extends BasePage{
    public Reports_TerminatedMembersPage() {
    }

    private static final By TerminatedMembersReport = By.xpath("//a[contains(text(),'Terminated Members Report')]");
    public static void clickOnTerminatedMembersReport() {
        clickOn(TerminatedMembersReport, WaitStrategy.CLICKABLE, "Terminated Members Report");
        waitupto(1000);
    }

    private static final By reasonCodeDropDown = By.xpath("(//button[@class='multiselect dropdown-toggle custom-select'])[1]");
