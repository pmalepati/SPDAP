...
public class Reports_MembershipbyCountyPage extends BasePage{

    public Reports_MembershipbyCountyPage() {
    }

    private static final By MembershipbyCounty = By.xpath("//a[contains(text(),'Membership by County')]");
    public static void clickOnMembershipbyCounty() {
        clickOn(MembershipbyCounty, WaitStrategy.CLICKABLE, "Membership by County");
        waitupto(1000);
    }

    private static final By countyNameDropDown = By.xpath("(//button[@class='multiselect dropdown-toggle custom-select'])[1]");
    public static void selectOnCountyName() {
        clickOn(countyNameDropDown, WaitStrategy.CLICKABLE, "County Name :");
        waitupto(1000);
    }
